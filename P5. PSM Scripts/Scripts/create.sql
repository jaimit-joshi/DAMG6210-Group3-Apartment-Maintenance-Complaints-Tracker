...
BuildingID INT IDENTITY(100,1) NOT NULL,
...
UnitID INT IDENTITY(2000,2) NOT NULL,
...
ResidentID INT IDENTITY(300,5) NOT NULL,
...
ManagerID INT IDENTITY(1100,1) NOT NULL,
...
VendorID INT IDENTITY(12000,5) NOT NULL,
...
CategoryID INT IDENTITY(250,2) NOT NULL,
...
AmenityID INT IDENTITY(3500,1) NOT NULL,
...
-- 8. WORKER Table
CREATE TABLE WORKER (
WorkerID INT IDENTITY(400,2) NOT NULL,
...
-- 9. LEASE Table
CREATE TABLE LEASE (
LeaseID INT IDENTITY(5000,5) NOT NULL,
...
ContactID INT IDENTITY(601,1) NOT NULL,
ResidentID INT NOT NULL,
...
OccupantID INT IDENTITY(7020,2) NOT NULL,
...
BuildingAmenityID INT IDENTITY(830,1) NOT NULL,
BuildingID INT NOT NULL,
...
UnitAmenityID INT IDENTITY(9400,5) NOT NULL,
UnitID INT NOT NULL,
AmenityID INT NOT NULL,
...
AssignmentID INT IDENTITY(10000,1) NOT NULL,
BuildingID INT NOT NULL,
...
RequestID INT IDENTITY(111,1) NOT NULL,
ResidentID INT NOT NULL,
UnitID INT NOT NULL,
...
WorkOrderID INT IDENTITY(2222,2) NOT NULL,
...
AssignmentID INT IDENTITY(333,5) NOT NULL,
...
InvoiceID INT IDENTITY(44444,1) NOT NULL,
...
EscalationID INT IDENTITY(555,1) NOT NULL,
...
TransactionID INT IDENTITY(666,2) NOT NULL,
LeaseID INT NOT NULL,
ResidentID INT NOT NULL,
